...
Hopefully, this was a helpful recap of what was covered in chapter 7.
...
## Bootstrapping as it relates to probability
...
Another variable which, troublingly, raises concerns regarding validity is the `att_end` variable. Through this variable, Enos hopes to measure how people's political attitudes change — however, what he is truly measuring is how people respond to his specific survey questions
This is not to say his choices were unreasonable — rather, he would have gotten very different answers 

It is always important to keep the problem of validity in the back of our minds as we investigate data sets and how the data within these sets are collected.
...
Clearly, using the same control and treatment values to fill in the unknowns doesn't capture the entire picture. While using `lm()` to fill in the `att_end` unknowns towards the center of the distribution, it makes less sense for values towards the outskirts.
