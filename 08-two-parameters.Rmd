...
Now, we'll create the RCM table of possible outcomes, as we did back in ch3: here, we will be using the first seven subjects of the `trains` dataset, two of which are control subjects and five of which are treated subjects.
